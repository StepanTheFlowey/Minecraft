...
template <typename T>
constexpr Triangle3<T>::Triangle3() {

}

template <typename T>
constexpr Triangle3<T>::Triangle3(const Vec3<T> _a, const Vec3<T> _b, const Vec3<T> _c) {
  a = _a;
  b = _b;
  c = _c;
}
...
constexpr Triangle3<T>::Triangle3(const Triangle3<U>& triangle) {
  a = triangle.a;
  b = triangle.b;
  c = triangle.c;
}
